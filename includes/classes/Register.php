	...
	*/
	class Register{
		...
		public function sendAccountVerificationMail($email, $token){
			...
			$mail->SMTPSecure = 'tls';
			$mail->SMTPAuth = true;
			$mail->Username = "nikhil.singhal_cs16@gla.ac.in";
			$mail->Password = "nikhilsinghal123";
			$mail->setFrom('nikhil.singhal_cs16@gla.ac.in', 'Chit-Chat');
			$mail->addAddress($email, $this->username);
			$mail->Subject = "Chit-Chat Account Verification";
		...
		public function sendPasswordForgottenMail($email, $token){
			...
			$mail->Subject = "Reset your Chit-Chat Account Password";
			$mail->Body = "<body bgcolor='#f9f9f9'>
